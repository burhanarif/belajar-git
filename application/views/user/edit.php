            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'manajer' ? 'checked' : ''; ?> <?= set_radio('role', 'manajer'); ?> value="manajer" type="radio" id="manajer" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="manajer">manajer</label>
                        </div>
